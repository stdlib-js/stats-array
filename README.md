...
```javascript
import { max, maxBy, maxabs, maxsorted, mean, mediansorted, min, minBy, minabs, minsorted, mskmax, mskmin, mskrange, nanmax, nanmin, varianceyc } from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-array@esm/index.mjs';
```
