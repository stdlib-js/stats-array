...
```javascript
import { max, maxBy, maxabs, maxsorted, mean, mediansorted, min, minabs, minsorted, mskmax, mskmin, mskrange, nanmax, nanmin, varianceyc } from 'https://cdn.jsdelivr.net/gh/stdlib-js/stats-array@deno/mod.js';
```
